def define_env(env):
    ...
    - [GitHub repository](https://github.com/BentoBoxWorld/BentoBox)
    ([Releases](https://github.com/BentoBoxWorld/BentoBox/releases))
    - [Issue tracker](https://github.com/BentoBoxWorld/BentoBox/issues)
    - [Development builds](https://ci.codemc.org/job/BentoBoxWorld/job/BentoBox)
    ([Latest stable build](https://ci.codemc.io/job/BentoBoxWorld/job/BentoBox/lastStableBuild/))
    """
