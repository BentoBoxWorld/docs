def define_env(env):
    ...
    - [GitHub repository](https://github.com/BentoBoxWorld/{env.variables.page.title})
    ([Releases](https://github.com/BentoBoxWorld/{env.variables.page.title}/releases))
    - [Issue tracker](https://github.com/BentoBoxWorld/{env.variables.page.title}/issues)
    - [Development builds](https://ci.codemc.org/job/BentoBoxWorld/job/{env.variables.page.title})
    ([Latest stable build](https://ci.codemc.io/job/BentoBoxWorld/job/{env.variables.page.title}/lastStableBuild/))
    """
