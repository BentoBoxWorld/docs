...
| acidisland.island.team.accept | Allow use of '/ai team accept' command - accept an invitation | TRUE |
...
| acidisland.admin.blueprint.save | Allow use of '/acid blueprint save' command - save the copied clipboard | OP |
