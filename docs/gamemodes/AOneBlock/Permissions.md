...
permissions:
  aoneblock.count:
    description: Allow use of the aoneblock count command
    default: true   
  aoneblock.island:
  ...
  aoneblock.admin.setspawn:
    ...
    default: op
  aoneblock.admin.setrange:
    description: Allows setting of island protection range
    default: op
  aoneblock.admin.settingsreset:
